...
let myFirstServer = httpRef.createServer((request, response)=>{
    ...
    response.write("<h2>i am ghost/anynomous arrow function</h2>")
    response.write(`
        <ol>
            <li>Hello 1</li>
            <li>Hello 2</li>
    ...
    `)
    response.write(`<iframe width="560" height="315" src="https://www.youtube.com/embed/stGUpMav1sc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`)
